...
const useStyles = makeStyles((theme) => ({
  ...
  //   height: "100vh",
  //   background: "#000",
  //   boxShadow: "0 0 20px rgb(0 0 0 / 33%)",
  //   overflowY: "auto",
  //   "&::-webkit-scrollbar": {
  //     display: "none",
  //   },
  ...
  //   justifyContent: "center",
  //   boxShadow:
  //     "#903eff54 0px 30px 60px -12px inset, #9168ff40 0px 18px 36px -18px inset",
  // },
  opetionBox: {
    gap: "0.75rem",
    display: "grid",
  ...
  joinexambtn: {
    padding: "10px 15px",
    backgroundImage:
      "linear-gradient(180deg, #001f37 0%, rgb(15 46 159 / 38%) 100%)",
    color: "var(--text-color)",
    borderRadius: "9999px",
  ...
  view3joinexamterms: {
    ...
    // background: "#101010", // for 02 routs
  ...
  //   overflow: "hidden",
  //   // backgroundImage:url()
  //   //   "https://aimax.wpengine.com/wp-content/uploads/2023/06/parallax-section-bg.png",
  //   backgroundSize: "cover",
  //   backgroundPosition: "center",
  // },
}));
