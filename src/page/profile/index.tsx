      ...
      <div className={classes.middleportion}>
        {userfind ? (
          <div className={`d-flex ${classes.profilemiddle} flex-column`}>
            <div>
              <h3 className={`${classes.profileuser}  ${classes.proileFont}`}>
                User :
            ...
            <div className={`${classes.usercoinbtn} `}>
              ...
              <span className="ml-5">
                {!walletFetching &&
                  ...
                  walletList.data.status === "ok" &&
                  walletList.data.response.balance}
              </span>
            </div>
            <button
              className={`${classes.userlogout} fs-15`}
              onClick={logoutuser}
            >
              Logout
            </button>
          ...
          <>
            <div className={classes.profiletop}>
              ...
              <div className={classes.profileusermain}>
                <h2 className={`${classes.profileuser}  ${classes.proileFont}`}>
                  User : Guest
                </h2>
              </div>
            </div>
            <div className={`d-flex ${classes.profilemiddle}`}>
              <button className={`${classes.joinexambtn} fs-15`}>
                Coins{" "}
                <span className="ml-5">{sessionStorage.getItem("coin")}</span>
              </button>
